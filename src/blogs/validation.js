...
const searchSchema = {
  title: {
    in: ["query"],
    isString: {
      errorMessage: "title must be in query and type must be a string to search!",
    },
  },
};
...
const commentSchema = {
  text: {
    isString: {
      errorMessage: "Text field is required for a comment",
    },
  },
  userName: {
    isString: {
      errorMessage: "User name is required for a comment",
    },
  },
};
